...
ProxyPlugin.init = function () {
    if (sogouExplorer.experimental !== undefined && sogouExplorer.experimental.proxy !== undefined)
        ProxyPlugin._proxy = sogouExplorer.experimental.proxy;
    else if (sogouExplorer.proxy !== undefined)
        ProxyPlugin._proxy = sogouExplorer.proxy;
    else
